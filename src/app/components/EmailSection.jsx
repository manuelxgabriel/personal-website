      ...
      <div className='z-10'>
        ...
        <div className='socials flex flex-row gap-2'>
          <Link href="github.com" >
            <Image src={GithubIcon} className='w-20 h-20 p-3' alt='Github Icon'></Image>
          </Link>
          <Link href="Linkedin.com">
            <Image src={LinkedinIcon} className='w-20 h-20 p-3' alt='LinkedIn Icon'></Image>
          </Link>
        </div>
      </div>
      {/* <div>
        <form className='flex flex-col gap-6' onSubmit={handleSubmit}>
          ...
          <div className='mb-6'>
            <label
              htmlFor='subject'
              className='text-white blocktext-sm mb-2 font-medium'>
              Subject
            </label>
            <input
              name='subject'
